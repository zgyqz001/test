...
sql.executeUpdate("delete from yxcourse where id='"+name+"'");
String t="select* from yxcourse ";
rs=sql.executeQuery(t);
%>

<table align="center"     boder="30"   bgcolor="#258467"> 
<tr><td align="center" colspan="4"><b>退选后课程</b></td></tr>
<% 
while(rs.next()){
